...
True
>>> q.enqueue(4) # 栈内容：[4]
>>> q.enqueue('dog') # 栈内容：['dog', 4]
>>> q.enqueue(True) # 栈内容：[True, 'dog', 4]
>>> q.size() # 栈内容：[True, 'dog', 4]
3
>>> q.isEmpty() # 栈内容：[True, 'dog', 4]
False
>>> q.enqueue(8.4) # 栈内容：[8.4, True, 'dog', 4]
>>> q.dequeue() # 栈内容：[8.4, True, 'dog']
4
>>> q.dequeue() # 栈内容：[8.4, True]
'dog'
>>> q.size() # 栈内容：[8.4, True]
2
```
